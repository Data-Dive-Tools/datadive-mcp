...
- The tool description names product title, BSR, category and category tree, so the model knows they are available. Titles support pack-size, material and count analysis; BSR supports ranking Competitors by sales position.
